let text = "Ljudje so živeli v večjih skupnostih, ki so poleg staršev in otrok vključevale tudi stare starše ";
	...
	text += "orožje in orodje. Ženske so nabirale sadeže, ";
	text += "pripravljale hrano, varovale ogenj in skrbele ";
	text += "za otroke. Ženske so zaradi materinstva ";
	text += "zelo cenili. Otroci so že od najzgodnejših let ";
