let text = "V družinah meščanov so veliko pozornost ";
	...
	text += "varnost in premoženje družine. Bil je zgled ";
	text += "svojim sinovom. Žene so bile podrejene ";
	text += "možem, njihova dolžnost je bila vodenje ";
	text += "gospodinjstva in vzgoja hčera. Kmečke in ";
